...
var _require = require('../../utils/priceUtils'),
    parsePrice = _require.parsePrice;
...
var propertySchema = new mongoose.Schema({
  ...
  status: {
    type: String,
    "enum": ['available', 'active', 'sold', 'rented', 'inactive', 'deleted', 'pending', 'approved', 'changes-required', 'cancelled'],
    "default": 'active',
    index: true
  },
  featured: {
  ...
  toJSON: {
    ...
    transform: function transform(doc, ret) {
      delete ret.__v; // Preserve original subcategory value; add normalized version for UI if needed

      var rawSub = String(ret.subcategory || ret.subCategory || ret.category || '').toLowerCase();
      var normalizedSubcategory = 'Flat';
...
propertySchema.pre('save', function (next) {
  ...
  var rawSub = String(this.subcategory || this.subCategory || this.category || '').toLowerCase();
  var normalizedSubcategory = 'Flat';
