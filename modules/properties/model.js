...
const propertySchema = new mongoose.Schema({
  ...
  bathrooms: { type: String, default: 'N/A', trim: true },
  balconies: { type: Number },
  bhk: { type: String, default: 'N/A', trim: true },
  floors: { type: Number },
  totalFloors: { type: Number },
  floor: { type: String, default: 'N/A', trim: true },
  facing: { type: String, default: '', trim: true },
  furnishing: { type: String, default: 'N/A', trim: true },
  furnishingStatus: { type: String, trim: true },
  propertyAge: { type: String, default: '', trim: true },
  parking: { type: String, default: 'N/A', trim: true },
  ...
  status: { type: String, enum: ['active', 'sold', 'rented', 'inactive', 'deleted'], default: 'active', index: true },
