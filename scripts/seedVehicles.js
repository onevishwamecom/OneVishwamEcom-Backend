...
const vehicles = [
  {
    ...
    showroom: { name: 'Honda Dream Showroom', address: 'No. 45, MG Road, Ashok Nagar, Bangalore - 560001', phone: '+91 98765 43210', mapsLink: 'https://maps.google.com/?q=Honda+Showroom+Bangalore+MG+Road' },
  ...
  },
  {
    ...
    showroom: { name: 'Bajaj Pro Showroom', address: '12, KRS Road, Bannimantap, Mysore - 570015', phone: '+91 98765 43211', mapsLink: 'https://maps.google.com/?q=Bajaj+Showroom+Mysore' },
  ...
  },
  {
    ...
    showroom: { name: 'Toyota Liva Motors', address: '88, Old Airport Road, Domlur, Bangalore - 560017', phone: '+91 98765 43212', mapsLink: 'https://maps.google.com/?q=Toyota+Showroom+Bangalore+Airport+Road' },
  ...
  },
  {
    ...
    showroom: { name: 'Maruti Suzuki Arena', address: 'Survey No. 120, Gokul Road, Hubli - 580030', phone: '+91 98765 43213', mapsLink: 'https://maps.google.com/?q=Maruti+Showroom+Hubli' },
  ...
  },
  {
    ...
    showroom: { name: 'Tata Motors Commercial', address: 'NH-66, Panambur, Mangalore - 575010', phone: '+91 98765 43214', mapsLink: 'https://maps.google.com/?q=Tata+Motors+Mangalore' },
    loanApproved: true, featured: true, variants: 3,
  ...
  },
  {
    ...
    showroom: { name: 'Ashok Leyland Truck Zone', address: 'Plot 56, Peenya Industrial Area, Bangalore - 560058', phone: '+91 98765 43215', mapsLink: 'https://maps.google.com/?q=Ashok+Leyland+Peenya+Bangalore' },
  ...
  },
  {
    ...
    showroom: { name: 'Bajaj 3W Hub', address: '22, Mysore-Nanjangud Road, Metagalli, Mysore - 570016', phone: '+91 98765 43216', mapsLink: 'https://maps.google.com/?q=Bajaj+3W+Mysore' },
  ...
  },
  {
    ...
    showroom: { name: 'Ola Experience Centre', address: '1st Floor, VR Mall, Whitefield, Bangalore - 560066', phone: '+91 98765 43217', mapsLink: 'https://maps.google.com/?q=Ola+Experience+Whitefield' },
